...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2021 a las 05:31:20
...
(4, 'Devuelveme a mi Chica', 'Hombres G', 'Rock en Español', '1990', 'https://www.youtube.com/watch?v=4iJJCaSyoSw', NULL),
(5, 'Fresa salvaje', 'Camilo Sexto', 'Baladas Romanticas', '1973', 'https://www.youtube.com/watch?v=gIFgefSSTHo', NULL),
(6, 'Thriller', 'Michael Jackson', 'Funk, Pop, Disco', '1982', 'https://www.youtube.com/watch?v=sOnqjkJTMaA', NULL),
(7, 'Puerto Mont', 'Los Iracundos', 'Balada Romantica', '2000', 'https://www.youtube.com/watch?v=5TePzHvg_3g', NULL);
